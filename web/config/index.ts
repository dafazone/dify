...
if (process.env.NEXT_PUBLIC_API_PREFIX && process.env.NEXT_PUBLIC_PUBLIC_API_PREFIX) {
  ...
  apiPrefix = 'http://192.168.60.146:5001/console/api'
  publicApiPrefix = 'http://192.168.60.146:5001/api' // avoid browser private mode api cross origin
  marketplaceApiPrefix = 'http://192.168.60.146:5001/api'
}
